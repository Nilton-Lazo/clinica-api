...
class CajaTipoDocumentoUpdateRequest extends FormRequest
{
    ...
    {
        $id = $this->route('cajaTipoDocumento')?->id;
        return [
            'codigo' => ['required', 'string', 'max:50', Rule::unique('caja_tipos_documento', 'codigo')->ignore($id)],
    ...
    public function messages(): array
    {
        return [
            ...
            'codigo.unique' => 'Ya existe un tipo de documento de caja con ese código.',
