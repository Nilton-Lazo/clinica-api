...
class TarifaUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $iafaRule = ['nullable', 'integer', Rule::exists('iafas', 'id')];

        if ($tarifa && $this->has('iafa_id') && (int)$this->input('iafa_id') !== (int)$tarifa->iafa_id) {
            $iafaRule = [
                'nullable',
                'integer',
    ...
    {
        return [
            'codigo.prohibited' => 'El código de la tarifa lo genera el sistema; no lo modifiques manualmente.',
            'fecha_creacion.prohibited' => 'La fecha de creación de la tarifa la registra el sistema; no la modifiques manualmente.',
            ...
            'estado.required' => 'Selecciona el estado de la tarifa.',
