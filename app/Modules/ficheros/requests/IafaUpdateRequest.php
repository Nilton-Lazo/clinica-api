...
class IafaUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rucRule = Rule::unique('iafas', 'ruc');
        if ($iafa) {
            $rucRule = $rucRule->ignore($iafa->id);
        }
        ...
        return [
            ...
            'ruc' => ['required', 'string', 'regex:/^\d{11}$/', $rucRule],
    ...
    {
        return [
            'codigo.prohibited' => 'El código de la IAFAS lo genera el sistema; no lo modifiques manualmente.',
            ...
            'estado.required' => 'Selecciona el estado de la IAFAS.',
